    ...
    <div className='w-full h-full flex items-start justify-start p-4 relative'>
      ...
      <div className='absolute top-32 right-20'>
        ...
        <div className='absolute   top-52   p-2 flex items-center flex-col justify-center'>
          ...
          <button onClick={() => navigate('/personal-trainer')} className='border-2 my-2  mx-10 border-orange-600   p-2 rounded text-xl font-semibold transition-all duration-300 hover:bg-orange-600 hover:text-white'>APPLY NOW</button>
        </div>
      </div>
    </div>
  )
